...
left = OpenApiParameter(
    'left', location=OpenApiParameter.QUERY, description='left', type=OpenApiTypes.NUMBER, required=True
)
right = OpenApiParameter(
    'right', location=OpenApiParameter.QUERY, description='right', type=OpenApiTypes.NUMBER, required=True
)
top = OpenApiParameter(
    'top', location=OpenApiParameter.QUERY, description='top', type=OpenApiTypes.NUMBER, required=True
)
bottom = OpenApiParameter(
    'bottom', location=OpenApiParameter.QUERY, description='bottom', type=OpenApiTypes.NUMBER, required=True
)
